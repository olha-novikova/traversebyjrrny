...
class WP_Job_Manager_Form_Submit_Job extends WP_Job_Manager_Form {
	...
	public function init_fields() {
		...
		$this->fields = apply_filters( 'submit_job_form_fields', array(
			'job' => array(
				'job_title' => array(
					'label'       => __( 'Campaign Name', 'wp-job-manager' ),
					'type'        => 'text',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 1
				...
				'job_location' => array(
					'label'       => __( 'Sponsored Content', 'wp-job-manager' ),
					'description' => __( '' ),
					'type'        => 'checkbox',
					'required'    => true,
					'placeholder' => __( '' ),
				...
				'job_category' => array(
					'label'       => __( 'Twitter', 'wp-job-manager' ),
					'type'        => 'checkbox',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 4,
				...
				'job_description' => array(
					'label'       => __( 'Instagram', 'wp-job-manager' ),
					'type'        => 'checkbox',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 5
				...
				'application' => array(
					'label'       => __( 'Pinterest', 'wp-job-manager' ),
					'type'        => 'checkbox',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 6
