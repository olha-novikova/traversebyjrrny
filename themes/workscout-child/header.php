                ...
                $.magnificPopup.open({
                    items: {
                        src: '<div id="singup-dialog" class="small-dialog zoom-anim-dialog apply-popup">'+
                            ...
                            '<p class="margin-reset"><?php esc_html_e( 'This is where you will create specific portfolios for your blog, photography, social accounts, and more. The sky’s the limit! Remember: the more descriptive you are, the more brands will see how perfect a fit you can be.', 'woocommerce' ); ?></p>'+
                            '<p class="margin-top-20 margin-bottom-20"><a class="button" href="<?php echo esc_url( get_permalink( $resume_page ) ); ?>"><?php esc_html_e( 'Lets Go', 'workscout' ); ?></a></p>'+
