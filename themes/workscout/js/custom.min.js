! function(e) {
    ...
    e(document).ready(function() {
        ...
        }), e(document).on("submit", ".small-dialog-content.woo-reg-box form.login, .small-dialog-content.woo-reg-box form.register", function(t) {
            var a = e(this),
                n = !1,
                o = e(this).serialize(),
                i = e(this).find("input[type=submit]");
            e(i).css("backgroundColor", "#ddd");
            var s = o + "&" + i.attr("name") + "=" + i.val();
            e("#ajax-response"), e.ajax({
                ...
                async: !1,
                success: function(o) {
                    a.find(e(".woocommerce-error")).remove();
                    var s = e("#ajax_response"),
                        r = e.parseHTML(o);
                    if (s.append(r), n = s.find(e(".woocommerce-error")), e(i).css("backgroundColor", ws.theme_color), n.length > 0) a.prepend(n.clone()), s.html(""), t.preventDefault();
                    else {
                        if (a.hasClass("register")) return window.location.href = ws.woo_account_page, t.preventDefault(), !1;
