...
<div id="resume-manager-candidate-dashboard">
	<p class="margin-bottom-25"><?php echo _n( 'Your Portfolio can be viewed, edited or removed below.', 'Your Portfolio(s) can be viewed, edited or removed below.', resume_manager_count_user_resumes(), 'workscout' ); ?></p>
	<table class="resume-manager-resumes manage-table resumes responsive-table">
		...
		<tbody>
			<?php if ( ! $resumes ) : ?>
				<tr>
					<td colspan="<?php echo sizeof( $candidate_dashboard_columns ); ?>"><?php esc_html_e( 'You do not have any active Portfolio.', 'workscout' ); ?></td>
					<td></td>
				</tr>
			<?php else : ?>
